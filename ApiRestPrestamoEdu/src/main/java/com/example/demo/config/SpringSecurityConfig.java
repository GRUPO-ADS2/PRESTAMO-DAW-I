...
//    private String origenAngular;
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		return http.authorizeHttpRequests((authz) -> authz
						...
						.requestMatchers(HttpMethod.GET,"/mantenimiento/**").hasAnyAuthority("ADMIN")
						.requestMatchers(HttpMethod.POST,"/mantenimiento/**").hasAnyAuthority("ADMIN")
				...
				.formLogin((form) -> form
						.loginPage("/login")
						.defaultSuccessUrl("/mantenimiento/materiales")
						.permitAll())
